...
> **Notice:** It is not necessary to download the ATOM firmware before use, but when switching from Arduino to python programming, it is necessary to re-download the minirobot firmware "Transponder".

| <img src="../resources/3-UserNotes/3.1-SafetyInstructions/warning.png" alt="img-1" width="100" height=“100” />       | Please read the interface protocol document in detail and proceed with your program development after testing. |
|------------------------|-------------------|
