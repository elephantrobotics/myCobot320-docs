#C # myCobot320-PI environment setup
...
<img src="../resourse/15-ApplicationBaseCSharp/9.2/9-2-3-001.png" alt="9-2-3-001" width="50%"><br>
4 Change the compilation method to ** Release **<Br>
<img src="../resourse/15-ApplicationBaseCSharp/9.2/9-2-3-002.png" alt="9-2-3-002" width="50%"><br>
...
![pic](../resourse/15-ApplicationBaseCSharp/9.2/9-2-3-003.gif)<br>
6 Operation<br>
Attention: Compile&&Run, the entire operation process can be seen in the following dynamic diagram:<br>
![pic](../resourse/15-ApplicationBaseCSharp/9.2/9-2-3-004.gif)<br> 