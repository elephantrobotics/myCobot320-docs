...
**WriteAngle(Joint joint, double value, int speed = DefaultSpeed)**[example](12.4-case.md#jointcontrol)<br>
...
**GetJointMin(Joint joint)** [example](12.4-case.md#jointcontrol)<br>
 ...
 **GetJointMax(Joint joint)**[example](12.4-case.md#jointcontrol)<br>
...
**JogAngle(Joint joint, int direction, int speed = DefaultSpeed)**[example](12.4-case.md#jointcontrol) <br>
...
**JogAngleAbsolute(Joint joint, double value, int speed = DefaultSpeed)**[example](12.4-case.md#jointcontrol)<br> 
...
**JogAngleIncrement(Joint joint, double increment, int speed = DefaultSpeed)**[example](12.4-case.md#jointcontrol) <br> 
...
**WriteAngles(const Angles& angles, int speed = DefaultSpeed)**[example](12.4-case.md#jointcontrol)<br> 
Return value: no <br>
...
**WriteCoord(Axis axis, double value, int speed = DefaultSpeed)** [example](12.4-case.md#coordinatecontrol) <br> 
Return value: no<br>
...
**JogCoord(Axis axis, int direction, int speed = DefaultSpeed)** [example](12.4-case.md#coordinatecontrol)<br>
...
**JogCoordAbsolute(Axis axis, double value, int speed = DefaultSpeed)**[example](12.4-case.md#coordinatecontrol) <br>
...
**JogCoordIncrement(Axis axis, double increment, int speed = DefaultSpeed)**[example](12.4-case.md#coordinatecontrol) <br>
...
**WriteCoords(const Coords& coords, int speed = DefaultSpeed)**[example](12.4-case.md#coordinatecontrol)<br>
Return value: no<br>
...
**SetBasicOut(int pin_number, int pin_signal)**[example](12.4-case.md#iocontrol)<br> 
Return value: no<br> 
...
**GetBasicIn(int pin_number)**[example](12.4-case.md#iocontrol) <br>
...
**SetDigitalOut(int pin_number, int pin_signal)** [example](12.4-case.md#iocontrol)<br>
Return value: no <br>
...
**GetDigitalIn(int pin_number)**[example](12.4-case.md#iocontrol) <br>
Return value: pin state (0-low level; 1-high level)<br>
...
<img src="../resources/12-ApplicationBaseCPlus/12.3/12-6-001.png" alt="12-6-001" width="50%"><br>
...
<img src="../resources/12-ApplicationBaseCPlus/12.3/12-6-002.png" alt="12-6-002" width="50%"><br>

## 1 Adaptive gripper control 
supports: myCobot280, 320 && myPalletizer 260 <br>
**SetGriper(int open)** [example](12.4-case.md#grippercontrol)<br>
Return value: no <br>
...
**SetElectricGriper(int open)** [example](12.4-case.md#grippercontrol)<br>
Return value: no <br>
parameter description: gripper switch state (0-off; 1-on)<br>
Case: Due to the delay, when the gripper is controlled for the first time, the gripping may not be successful. Therefore it is recommended to send twice<br>
