...
**WriteAngle(Joint joint, double value, int speed = DefaultSpeed)**[example](12.4-case.md#WriteAngle)<br>
...
**GetJointMin(Joint joint)** [example](12.4-case.md#angle)<br>
 ...
 **GetJointMax(Joint joint)**[example](12.4-case.md#angle)<br>
...
**JogAngle(Joint joint, int direction, int speed = DefaultSpeed)**[example](12.4-case.md#angle) <br>
...
**JogAngleAbsolute(Joint joint, double value, int speed = DefaultSpeed)**[example](12.4-case.md#angle)<br> 
...
**JogAngleIncrement(Joint joint, double increment, int speed = DefaultSpeed)**[example](12.4-case.md#angle) <br> 
...
**WriteAngles(const Angles& angles, int speed = DefaultSpeed)**[example](12.4-case.md#angle)<br> 
Return value: no <br>
...
**WriteCoord(Axis axis, double value, int speed = DefaultSpeed)**[example](12.4-case.md#angle)<br> 
Return value: no<br>
