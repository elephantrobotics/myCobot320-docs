...
**WriteAngle(Joint joint, double value, int speed = DefaultSpeed)**[See examples](12.4-case.md#WriteAngle)<br>
Return value: no parameter <br>
parameter description: Parameter 1: joint number (1-6) Parameter 2: angle ( -170°- 170° ) Parameter 3: speed ( **180-18000**), the example with **3600** as a default<br>
example: <br>
	`mycobot::MyCobot::I().WriteAngle(mycobot::Joint::J1, 10, 3600);

### 1.2 Obtain the minimum Angle of single joint <br>
**GetJointMin(Joint joint)** [See examples](12.4-case.md#angle)<br>
 ...
 **GetJointMax(Joint joint)**[See examples](12.4-case.md#angle)<br>
...
**JogAngle(Joint joint, int direction, int speed = DefaultSpeed)**[See examples](12.4-case.md#angle) <br>
Function: to make a joint move until Jogstop or reaching a limited position<br> 
Return value: none<br> 
Parameter description: Parameter 1: joint number (1-6 ), Parameter 2: direction (1 - positive direction, and 0 - negative direction), and Parameter 3: speed (Default **3600**, ranging from 180 to 18000). Notice: This API will make the robot arm move in the forward and reverse directions, and it will stop moving after reaching the limited position or when JogStop is called during the movement<br>

example: <br>
`mycobot::MyCobot::I().JogAngle(mycobot::Joint::J1, 1, 30);`

### 1.5 Jog in absolute position on a specified joint <br>
**JogAngleAbsolute(Joint joint, double value, int speed = DefaultSpeed)**[See examples](12.4-case.md#angle)<br> 
...
**JogAngleIncrement(Joint joint, double increment, int speed = DefaultSpeed)**[See examples](12.4-case.md#angle) <br> 
...
**GetAngles()**[See examples](12.4-case.md#angle)<br>
Return value: Angles type <br>
parameter description: no 
example:<br> 
`mycobot::Angles angles= mycobot::MyCobot::I().GetAngles();` 
### 2.2 Send the angles of all joints 
**WriteAngles(const Angles& angles, int speed = DefaultSpeed)**[See examples](12.4-case.md#angle)<br> 
Return value: no <br>
parameter description: Parameter 1: all angles (std::array<double, Joints>, ranging from -170° to 170°) Parameter 2: speed ( **180-18000** ), the example with **3600** as a default<br>
...
**WriteCoord(Axis axis, double value, int speed = DefaultSpeed)**[See examples](12.4-case.md#angle)<br> 
Return value: no<br>
...
**JogCoord(Axis axis, int direction, int speed = DefaultSpeed)** [See examples](12.4-case.md#angle)<br>
...
**JogCoordAbsolute(Axis axis, double value, int speed = DefaultSpeed)**[See examples](12.4-case.md#angle) <br>
...
**JogCoordIncrement(Axis axis, double increment, int speed = DefaultSpeed)**[See examples](12.4-case.md#angle) <br>
...
**WriteCoords(const Coords& coords, int speed = DefaultSpeed)**[See examples](12.4-case.md#angle)<br>
Return value: no<br>
...
**SetBasicOut(int pin_number, int pin_signal)**[See examples](12.4-case.md#angle)<br> 
Return value: no<br> 
...
**GetBasicIn(int pin_number)**[See examples](12.4-case.md#angle) <br>
...
**SetDigitalOut(int pin_number, int pin_signal)** [See examples](12.4-case.md#angle)<br>
Return value: no <br>
...
**GetDigitalIn(int pin_number)**[See examples](12.4-case.md#angle) <br>
Return value: pin state (0-low level; 1-high level)<br>
...
<img src="../resources/12-ApplicationBaseCPlus/12.6/12-6-001.png" alt="12-6-001" width="50%"><br>
...
<img src="../resources/12-ApplicationBaseCPlus/12.6/12-6-002.png" alt="12-6-002" width="50%"><br>

## 1 Adaptive gripper control 
supports: myCobot280, 320 && myPalletizer 260 <br>
**SetGriper(int open)** [See examples](12.4-case.md#angle)<br>
Return value: no <br>
...
**SetElectricGriper(int open)** [See examples](12.4-case.md#angle)<br>
Return value: no <br>
parameter description: gripper switch state (0-off; 1-on)<br>
Case: Due to the delay, when the gripper is controlled for the first time, the gripping may not be successful. Therefore it is recommended to send twice<br>
