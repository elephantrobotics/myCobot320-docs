...
**JogCoord(Axis axis, int direction, int speed = DefaultSpeed)** [example](12.4-case.md#angle)<br>
...
**JogCoordAbsolute(Axis axis, double value, int speed = DefaultSpeed)**[example](12.4-case.md#angle) <br>
...
**JogCoordIncrement(Axis axis, double increment, int speed = DefaultSpeed)**[example](12.4-case.md#angle) <br>
...
**WriteCoords(const Coords& coords, int speed = DefaultSpeed)**[example](12.4-case.md#angle)<br>
Return value: no<br>
...
**SetBasicOut(int pin_number, int pin_signal)**[example](12.4-case.md#angle)<br> 
Return value: no<br> 
...
**GetBasicIn(int pin_number)**[example](12.4-case.md#angle) <br>
...
**SetDigitalOut(int pin_number, int pin_signal)** [example](12.4-case.md#angle)<br>
Return value: no <br>
...
**GetDigitalIn(int pin_number)**[example](12.4-case.md#angle) <br>
Return value: pin state (0-low level; 1-high level)<br>
...
**SetGriper(int open)** [example](12.4-case.md#angle)<br>
Return value: no <br>
...
**SetElectricGriper(int open)** [example](12.4-case.md#angle)<br>
Return value: no <br>
parameter description: gripper switch state (0-off; 1-on)<br>
Case: Due to the delay, when the gripper is controlled for the first time, the gripping may not be successful. Therefore it is recommended to send twice<br>
