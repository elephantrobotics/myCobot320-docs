...
**JogAngleAbsolute(Joint joint, double value, int speed = DefaultSpeed)**[example](12.4-example.md#jointcontrol)<br> 
...
**JogCoordAbsolute(Axis axis, double value, int speed = DefaultSpeed)**[example](12.4-example.md#coordinatecontrol) <br>
...
**SetGriper(int open)** [example](12.4-example.md#grippercontrol)<br>
Return value: no <br>
...
**SetElectricGriper(int open)** [example](12.4-example.md#grippercontrol)<br>
Return value: no <br>
parameter description: gripper switch state (0-off; 1-on)<br>
Case: Due to the delay, when the gripper is controlled for the first time, the gripping may not be successful. Therefore it is recommended to send twice<br>
