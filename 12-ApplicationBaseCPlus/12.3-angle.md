...
**WriteAngle(Joint joint, double value, int speed = DefaultSpeed)**[查看案例](8.4-case.md#angle)<br>
...
**GetJointMin(Joint joint)** [查看案例](8.4-case.md#angle)<br>
 ...
 **GetJointMax(Joint joint)**[查看案例](8.4-case.md#angle)<br>
...
**JogAngle(Joint joint, int direction, int speed = DefaultSpeed)**[查看案例](8.4-case.md#angle) <br>
...
**JogAngleAbsolute(Joint joint, double value, int speed = DefaultSpeed)**[查看案例](8.4-case.md#angle)<br> 
...
**JogAngleIncrement(Joint joint, double increment, int speed = DefaultSpeed)**[查看案例](8.4-case.md#angle) <br> 
...
**WriteAngles(const Angles& angles, int speed = DefaultSpeed)**[查看案例](8.4-case.md#angle)<br> 
Return value: no <br>
...
**WriteCoord(Axis axis, double value, int speed = DefaultSpeed)**[查看案例](8.4-case.md#angle)<br> 
Return value: no<br>
...
**JogCoord(Axis axis, int direction, int speed = DefaultSpeed)** [查看案例](8.4-case.md#angle)<br>
...
**JogCoordAbsolute(Axis axis, double value, int speed = DefaultSpeed)**[查看案例](8.4-case.md#angle) <br>
...
**JogCoordIncrement(Axis axis, double increment, int speed = DefaultSpeed)**[查看案例](8.4-case.md#angle) <br>
...
**WriteCoords(const Coords& coords, int speed = DefaultSpeed)**[查看案例](8.4-case.md#angle)<br>
Return value: no<br>
...
**SetBasicOut(int pin_number, int pin_signal)**[查看案例](8.4-case.md#angle)<br> 
Return value: no<br> 
...
**GetBasicIn(int pin_number)**[查看案例](8.4-case.md#angle) <br>
...
**SetDigitalOut(int pin_number, int pin_signal)** [查看案例](8.4-case.md#angle)<br>
Return value: no <br>
...
**GetDigitalIn(int pin_number)**[查看案例](8.4-case.md#angle) <br>
Return value: pin state (0-low level; 1-high level)<br>
...
**SetGriper(int open)** [查看案例](8.4-case.md#angle)<br>
Return value: no <br>
...
**SetElectricGriper(int open)** [查看案例](8.4-case.md#angle)<br>
Return value: no <br>
parameter description: gripper switch state (0-off; 1-on)<br>
Case: Due to the delay, when the gripper is controlled for the first time, the gripping may not be successful. Therefore it is recommended to send twice<br>
