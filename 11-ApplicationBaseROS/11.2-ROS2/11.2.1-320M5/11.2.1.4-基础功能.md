...
```bash
# mycobot 320-M5 版本的默认串行端口名称为"/dev/ttyUSB0"，波特率为 115200。某些型号的串行端口名称为 "dev/ttyACM0"。如果默认串行端口名称有误，可以将串行端口名称更改为"/dev/ttyACM0"。
...
[← 上一页](11.2.1.3-rviz2介绍.md) | [下一节 →](../../../12-ApplicationBaseCPlus/README.md)
